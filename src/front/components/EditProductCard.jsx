    ...
    return (
        <div className="flex flex-col mb-5">
            {products.map((product) => (
                <div
                    key={product.id}
                    className="flex items-center justify-between m-2 rounded-r-md border-2 border-gray-700 bg-gray-800 shadow-lg shadow-zinc-900/50"
                >
                    ...
                    <div className="text-white items-center mr-2 flex flex-col sm:flex-row gap-2">
                        ...
                        />
                        <Link to={`/selectproducttomodify/${product.id}`}>
